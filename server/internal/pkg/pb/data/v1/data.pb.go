...
func (x *ExportDBV1Response) GetDb() string {
	if x != nil {
		return x.Db
	}
	return ""
...
func (x *ImportDBV1Request) GetDb() string {
	if x != nil {
		return x.Db
	}
	return ""
...
var file_data_v1_data_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x64, 0x62, 0x22, 0x23, 0x0a, 0x11, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74,
	0x44, 0x42, 0x56, 0x31, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x64,
	0x62, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x64, 0x62, 0x22, 0x14, 0x0a, 0x12, 0x49,
